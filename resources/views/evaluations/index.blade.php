    ...
    <div class="mb-6">
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(18rem,0.8fr)_minmax(0,1.5fr)]">
            ...
            <div class="lg:col-span-2 rounded-xl bg-white p-6 shadow-sm border border-slate-200">
                <h2 class="text-xl font-semibold mb-4">Daftar Evaluasi</h2>
                        ...
                        <tbody>
                            @forelse($evaluations as $evaluation)
                                <tr class="border-b border-slate-100">
                                    <td class="py-3 pr-4">{{ $evaluation->title }}</td>
                                    <td class="py-3 pr-4">{{ $evaluation->type }}</td>
                                    <td class="py-3 pr-4">{{ $evaluation->status }}</td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="3" class="py-6 text-center text-slate-500">Belum ada evaluasi.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
